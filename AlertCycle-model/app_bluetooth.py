...
yolo_model = YOLO('alertcycleModelV1.onnx')
...
def main():
    ...
    uuid = "94f39d29-7d6d-437d-973b-fba39e49d4ee"  # Unique service UUID

    bluetooth.advertise_service(server_socket, "AlertCycleServer",
                                service_id=uuid,
                                service_classes=[uuid, bluetooth.SERIAL_PORT_CLASS],
                                profiles=[bluetooth.SERIAL_PORT_PROFILE])

    print(f"🔵 Waiting for Bluetooth Connecton on RFCOMM channel {port}...")
